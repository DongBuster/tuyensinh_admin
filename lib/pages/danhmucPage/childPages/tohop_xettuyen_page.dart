import 'dart:async';
import 'package:dkxt_admin/pages/danhmucPage/widgets/tohop_table.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:loading_animation_widget/loading_animation_widget.dart';
import '../../../data/repositories/tohop_page_repo.dart';

class TohopXettuyenPage extends StatefulWidget {
  const TohopXettuyenPage({super.key});

  @override
  State<TohopXettuyenPage> createState() => _TohopXettuyenPageState();
}

class _TohopXettuyenPageState extends State<TohopXettuyenPage> {
  Timer? _timer;
  ...
  @override
  void initState() {
    _future = tohopPageRepo.getListToHop();
    super.initState();
  }
      ...
      child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData && snapshot.data != null) {
              ...
              return ListView(
                shrinkWrap: true,
                children: [TohopTable(listToHop: snapshot.data)],
              );
            }
