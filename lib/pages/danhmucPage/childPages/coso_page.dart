...
import '../widgets/coso_table.dart';

class CosoPage extends StatefulWidget {
  const CosoPage({super.key});

  @override
  State<CosoPage> createState() => _CosoPageState();
}

class _CosoPageState extends State<CosoPage> {
  Timer? _timer;
  ...
  @override
  void initState() {
    _future = cosoPageRepo.getListCoso();
    super.initState();
  }
      ...
      child: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData && snapshot.data != null) {
            ...
            return ListView(
                shrinkWrap: true,
                children: [CosoTable(listCoso: snapshot.data)]);
          }
