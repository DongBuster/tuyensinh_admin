...
class HoSoTableForUser extends StatefulWidget {
  final FieldFilterDataModel fieldFilterData;
  const HoSoTableForUser({super.key, required this.fieldFilterData});

  @override
  State<HoSoTableForUser> createState() => _HoSoTableForUserState();
}

class _HoSoTableForUserState extends State<HoSoTableForUser> {
  int _currentPage = 1;
  int _pageSize = 10;
  int _totalRow = 0;
  List<ThiSinh> _data = [];
  ...
  @override
  void didUpdateWidget(covariant HoSoTableForUser oldWidget) {
