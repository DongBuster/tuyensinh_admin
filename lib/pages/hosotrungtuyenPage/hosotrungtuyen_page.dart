...
import 'widgets/trungtuyen_table.dart';

class HosotrungtuyenPage extends StatefulWidget {
  const HosotrungtuyenPage({super.key});

  @override
  State<HosotrungtuyenPage> createState() => _HosotrungtuyenPageState();
}

class _HosotrungtuyenPageState extends State<HosotrungtuyenPage> {
  Timer? _timer;
  bool _isLoadingExceeded = false;
  Future<dynamic>? _future;
  FieldFilterDataModel fieldFilterData = FieldFilterDataModel.init();
  final GlobalKey keyl = GlobalKey();
  @override
  void initState() {
    _future = TrungtuyenLogicUi.fetchListData();
    super.initState();
  }
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(
                        flex: 3,
                        child: SelectTextInput(
                          listData: GlobalVariable.listStatusTrungtuyenPage,
                          initValue:
                              GlobalVariable.listStatusTrungtuyenPage.first,
                          labelText: 'Trạng thái',
                          onSelected: (value) {
                            fieldFilterData.status = GlobalVariable
                                .mapStatusHosoTrungtuyenPage[value];
                          },
                        ),
                      ),
                    ],
                  ...
                  TrungtuyenTable(fieldFilterData: fieldFilterData),
                ],
              ),
            );
          }
